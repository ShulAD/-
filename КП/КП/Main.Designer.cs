namespace КП
{
    partial class Main
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.какРаботатьToolStripMenuItem.Size = new System.Drawing.Size(156, 22);
            this.какРаботатьToolStripMenuItem.Text = "Как работать ?";
            this.какРаботатьToolStripMenuItem.Visible = false;
            this.какРаботатьToolStripMenuItem.Click += new System.EventHandler(this.какРаботатьToolStripMenuItem_Click);
            // 
            // Main
            // 
